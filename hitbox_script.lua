...
-- MAIN WINDOW
-- ═══════════════════════════════════════════════
local MAIN_WINDOW_HEIGHT = 462
local MainFrame = Instance.new("Frame")
MainFrame.Name = "MainFrame"
MainFrame.Size = UDim2.new(0, 280, 0, MAIN_WINDOW_HEIGHT)
MainFrame.Position = UDim2.new(0.5, -140, 0.5, -MAIN_WINDOW_HEIGHT/2)
...
MainStrokeOuter.Transparency = 0.6
...
TitleAccentCorner.Size = UDim2.new(0, 4, 0, 24)
...
TitleText.Position = UDim2.new(0, 50, 0, 6)
...
ContentFrame.Size = UDim2.new(1, -24, 1, -72)
ContentFrame.Position = UDim2.new(0, 12, 0, 65)
...
SectionLeftBar.Size = UDim2.new(0, 3, 0, 20)
SectionLeftBar.Position = UDim2.new(0, 6, 0.5, -10)
...
SectionIcon.Size = UDim2.new(0, 25, 1, 0)
SectionIcon.Position = UDim2.new(0, 16, 0, 0)
...
SliderContainer.Position = UDim2.new(0, 0, 0, 100)
...
SliderValue.Position = UDim2.new(0.7, -14, 0, 8)
...
MinLabel.Position = UDim2.new(0, 14, 0, 53)
...
MaxLabel.Size = UDim2.new(0, 20, 0, 14)
MaxLabel.Position = UDim2.new(1, -34, 0, 53)
...
EspSectionHeader.Size = UDim2.new(1, 0, 0, 35)
EspSectionHeader.Position = UDim2.new(0, 0, 0, 178)
...
EspSectionLeftBar.Size = UDim2.new(0, 3, 0, 20)
EspSectionLeftBar.Position = UDim2.new(0, 6, 0.5, -10)
...
EspSectionIcon.Size = UDim2.new(0, 25, 1, 0)
EspSectionIcon.Position = UDim2.new(0, 16, 0, 0)
EspSectionIcon.BackgroundTransparency = 1
EspSectionIcon.Text = "👁"
EspSectionIcon.TextSize = 14
...
EspSectionTitle.Size = UDim2.new(1, -45, 1, 0)
EspSectionTitle.Position = UDim2.new(0, 44, 0, 0)
EspSectionTitle.BackgroundTransparency = 1
EspSectionTitle.Text = "PLAYER ESP"
EspSectionTitle.TextSize = 12
...
EspToggleContainer.Size = UDim2.new(1, 0, 0, 45)
EspToggleContainer.Position = UDim2.new(0, 0, 0, 213)
...
BufferRow.Size = UDim2.new(1, 0, 0, 24)
BufferRow.Position = UDim2.new(0, 0, 0, 258)
BufferRow.BackgroundColor3 = Colors.Panel
BufferRow.BorderSizePixel = 0
BufferRow.Parent = ContentFrame
CreateCorner(BufferRow, 6)
...
StatusBar.Size = UDim2.new(1, 0, 0, 55)
StatusBar.Position = UDim2.new(0, 0, 0, 292)
...
InfoText.Size = UDim2.new(1, -28, 0, 14)
InfoText.Position = UDim2.new(0, 14, 0, 32)
...
Footer.Text = "⚡ Henrydangerkk • v1.3"
Footer.TextSize = 10
...
MinimizeBtn.MouseButton1Click:Connect(function()
    Tween(MainFrame, {Size = UDim2.new(0, 280, 0, 0)}, 0.3, Enum.EasingStyle.Back, Enum.EasingDirection.In)
    task.wait(0.3)
...
ToggleGuiBtn.MouseButton1Click:Connect(function()
    ...
    Tween(MainFrame, {Size = UDim2.new(0, 280, 0, MAIN_WINDOW_HEIGHT)}, 0.35, Enum.EasingStyle.Back, Enum.EasingDirection.Out)
end)
...
Tween(MainFrame, {Size = UDim2.new(0, 280, 0, MAIN_WINDOW_HEIGHT)}, 0.5, Enum.EasingStyle.Back, Enum.EasingDirection.Out)
